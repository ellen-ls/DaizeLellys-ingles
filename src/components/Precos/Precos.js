    ...
    return (
        <div className='valores'>
            ...
            <Container className='container-valores' style={{ width: '100%'}}>
                <Row>
                    <Col>
                        <Card style={{width:'14rem',height: '40rem', textAlign: 'center',border:'none', backgroundColor:'#3c3b6e'}} className='card-valores'>
                    ...
                    <Col className='col-valores'>
                        <Card style={{width:'14rem', height: '45rem', textAlign: 'center', border:'none', backgroundColor:'#3c3b6e' }} className='card-valores'>
                            <Card.Img variant="top" src={consultoria} style={{ height: '15rem', borderRadius:'10px'}} />
                            <Card.Body>
                                <Card.Title style={{ fontSize: '18px', color:'#ffffff' }} className='linha'>Consultoria avaliativa</Card.Title>
                                <Card.Text style={{ fontSize: '15px', textAlign:'left', color:'#ffffff' }}>
